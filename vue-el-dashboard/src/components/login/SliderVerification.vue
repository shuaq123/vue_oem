  ...
  methods: {
    ...
    getImg() {
      ...
      this.$emit(GET_IMG_FUN, data => {
        ...
        if (!data) return;
        var img = new Image();
        this.backgroupImg = 'data:image/png;base64,' + data.bigImage;
        this.moveImg = 'data:image/png;base64,' + data.smallImage;
        this.margintop = data.yHeight
